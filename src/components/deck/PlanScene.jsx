...
export default function PlanScene() {
  return (
    <Scene contentClassName="gap-5">
        ...
        {initiatives.map((initiative, index) => {
          ...
          return (
            <motion.article
              ...
              className="flex items-center gap-4 rounded-[1.35rem] border border-[#2c5372]/[.08] bg-white/90 p-4 shadow-[0_14px_38px_rgba(44,83,114,.06)] backdrop-blur-xl"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 truncate text-[10px] text-[#5d86a5]">
                  {initiative.subtitle}
                </p>
              </div>
              <Badge
      ...
      <div className="grid flex-1 gap-4 lg:grid-cols-[minmax(0,1.28fr)_minmax(280px,.72fr)] xl:grid-cols-[minmax(0,1.28fr)_minmax(340px,.72fr)]">
        <MotionCard
        ...
        >
          ...
          <div className="mt-4 grid gap-x-5 gap-y-3 lg:grid-cols-2">
            <article className="rounded-2xl border border-[#2c5372]/[.07] bg-[#eaeff5]/55 p-4">
              <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-[#e83948]">
                Gente e Gestão
              </span>
              <p className="mt-2 text-xs leading-5 text-[#426a88]">
            ...
            <div className="lg:col-span-2 grid gap-3 sm:grid-cols-2">
              <div className="flex gap-3 rounded-2xl border border-[#e83948]/15 bg-[#e83948]/[.07] p-3.5">
                <CircleDot className="mt-0.5 size-4 shrink-0 text-[#e83948]" />
                <p className="text-[11px] leading-5 text-[#426a88]">
          ...
          <div className="mt-4 flex items-center gap-3 rounded-2xl bg-[#2c5372] px-4 py-3 text-white">
        ...
        <motion.section
          ...
          className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#2c5372] p-5 text-white shadow-[0_24px_65px_rgba(44,83,114,.2)]"
        >
          ...
          <div className="mt-4 divide-y divide-white/[.08]">
            {backlog.map((item, index) => (
              ...
              >
                <span className="font-display text-[10px] font-semibold text-[#eb7380]">
      ...
      >
        {timeline.map((phase, index) => (
          <article
            className="relative z-10 rounded-[1.4rem] border border-[#2c5372]/[.08] bg-white/92 p-4 shadow-[0_14px_40px_rgba(44,83,114,.06)] backdrop-blur-xl"
            key={phase.title}
          >
            ...
            <ul className="mt-2 space-y-1">
              {phase.items.map((item) => (
                <li
                  className="flex gap-2 text-[10px] leading-4 text-[#426a88]"
                  key={item}
                >
